...
%  airline_1   -    Adjacency matrix describing the US air transp. network
%                   for a randomized airline 1
%  airline_2   -    Adjacency matrix describing the US air transp. network
%                   for a randomized airline 2
%  airline_3   -    Adjacency matrix describing the US air transp. network
%                   for a randomized airline 3
...
nodesample = find(~ismember(1:N,lufthansa_airline));
...
h.MarkerSize = (log(P) - log(min(P))+0.01);
